...
/****** Object:  Job [DBAJOB - Export_Auditoria_BD_TXT_OtrosDias]    Script Date: 26/12/2016 03:43:21 p.m. ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 26/12/2016 03:43:21 p.m. ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBAJOB - Export_Auditoria_BD_TXT_OtrosDias', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Generar TXT]    Script Date: 26/12/2016 03:43:22 p.m. ******/
